...
// actions
import { changeSidebarType } from '../redux/features/layoutReducer';
...
const DetachedLayout = ({ children }: VerticalLayoutProps, state: VerticalLayoutState): React$Element<any> => {
    ...
    const { layoutColor, leftSideBarTheme, leftSideBarType, showRightSidebar } = useSelector((state) => state.layout);
