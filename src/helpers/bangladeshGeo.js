...
export const upazillas = [
    { id: '1', district_id: 'Comilla', name: 'Debidwar', bn_name: 'দেবিদ্বার', url: 'debidwar.comilla.gov.bd' },
    { id: '2', district_id: 'Comilla', name: 'Barura', bn_name: 'বরুড়া', url: 'barura.comilla.gov.bd' },
    {
        id: '3',
        district_id: 'Comilla',
        name: 'Brahmanpara',
    ...
    { id: '4', district_id: 'Comilla', name: 'Chandina', bn_name: 'চান্দিনা', url: 'chandina.comilla.gov.bd' },
    {
        id: '5',
        district_id: 'Comilla',
        name: 'Chauddagram',
    ...
    { id: '6', district_id: 'Comilla', name: 'Daudkandi', bn_name: 'দাউদকান্দি', url: 'daudkandi.comilla.gov.bd' },
    { id: '7', district_id: 'Comilla', name: 'Homna', bn_name: 'হোমনা', url: 'homna.comilla.gov.bd' },
    { id: '8', district_id: 'Comilla', name: 'Laksam', bn_name: 'লাকসাম', url: 'laksam.comilla.gov.bd' },
    { id: '9', district_id: 'Comilla', name: 'Muradnagar', bn_name: 'মুরাদনগর', url: 'muradnagar.comilla.gov.bd' },
    { id: '10', district_id: 'Comilla', name: 'Nangalkot', bn_name: 'নাঙ্গলকোট', url: 'nangalkot.comilla.gov.bd' },
    {
        id: '11',
        district_id: 'Comilla',
        name: 'Comilla Sadar',
    ...
    { id: '12', district_id: 'Comilla', name: 'Meghna', bn_name: 'মেঘনা', url: 'meghna.comilla.gov.bd' },
    {
        id: '13',
        district_id: 'Comilla',
        name: 'Monohargonj',
    ...
    { id: '14', district_id: 'Comilla', name: 'Sadarsouth', bn_name: 'সদর দক্ষিণ', url: 'sadarsouth.comilla.gov.bd' },
    { id: '15', district_id: 'Comilla', name: 'Titas', bn_name: 'তিতাস', url: 'titas.comilla.gov.bd' },
    { id: '16', district_id: 'Comilla', name: 'Burichang', bn_name: 'বুড়িচং', url: 'burichang.comilla.gov.bd' },
    { id: '17', district_id: 'Comilla', name: 'Lalmai', bn_name: 'লালমাই', url: 'lalmai.comilla.gov.bd' },
    { id: '18', district_id: 'Feni', name: 'Chhagalnaiya', bn_name: 'ছাগলনাইয়া', url: 'chhagalnaiya.feni.gov.bd' },
    { id: '19', district_id: 'Feni', name: 'Feni Sadar', bn_name: 'ফেনী সদর', url: 'sadar.feni.gov.bd' },
    { id: '20', district_id: 'Feni', name: 'Sonagazi', bn_name: 'সোনাগাজী', url: 'sonagazi.feni.gov.bd' },
    { id: '21', district_id: 'Feni', name: 'Fulgazi', bn_name: 'ফুলগাজী', url: 'fulgazi.feni.gov.bd' },
    { id: '22', district_id: 'Feni', name: 'Parshuram', bn_name: 'পরশুরাম', url: 'parshuram.feni.gov.bd' },
    { id: '23', district_id: 'Feni', name: 'Daganbhuiyan', bn_name: 'দাগনভূঞা', url: 'daganbhuiyan.feni.gov.bd' },
    {
        id: '24',
        district_id: '3',
