...
import MoneyTransferAddEdit from './MoneyTransferAddEdit';
...
const MoneyTransfer = () => {
    ...
    const [moneyTransferDelete] = useMoneyTransferDeleteMutation();
    const [moneyTransferMultiDelete] = useMoneyTransferMultiDeleteMutation();
    const [moneyTransferImport] = useMoneyTransferImportMutation();
    const { data, isLoading, isError } = useMoneyTransferListQuery(store, {
        skip: !store,
    });
        ...
        return (
            <>
                ...
                <span
                    ...
                    onClick={() => AleartMessage.Delete(row?.original._id, moneyTransferDelete)}>
    ...
    if (isLoading) {
        return (
            <>
                <PageTitle
                    breadCrumbItems={[{ label: t('moneyTransfer'), path: '/moneyTransfer', active: true }]}
        ...
        return (
            <>
                        ...
                        <Card>
                            <Card.Body>
                                <Table
                                    ...
                                    importFunc={moneyTransferImport}
                                    deleteMulti={moneyTransferMultiDelete}
                                    tableInfo={{
                                        tableName: 'moneyTransfer',
                                        exportFileName: 'moneyTransfer',
                ...
                <MoneyTransferAddEdit {...{ modal, setModal, toggle, editData, defaultValues }} />
            </>
        );
    }
};
