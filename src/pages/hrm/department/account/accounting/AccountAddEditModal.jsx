...
const AccountAddEditModal = ({ modal, setModal, toggle, editData, defaultValues }) => {
    ...
    const schemaResolver = yupResolver(
        yup.object().shape({
            ...
            initialBalance: yup.string().required(t('please enter initial balance')),
        })
    );
    ...
    const inputData = [
        ...
        },
        {
            ...
            type: 'text',
            name: 'accountNumber',
            placeholder: t('please enter account number'),
            containerClass: 'mb-3',
            col: 'col-12 col-md-6 col-lg-6',
            required: true,
        },
            ...
            <Card.Body>
                <Modal show={modal} onHide={toggle} backdrop="statica" keyboard={false} size="lg">
                    <Modal.Header onHide={toggle} closeButton>
                        <h4 className="modal-title">{editData ? t('update account') : t('add account')}</h4>
                    </Modal.Header>
                    ...
                    <Modal.Body>
                        <MappedComponent
                            ...
                            editData={editData}
                            updateTitle={t('update account')}
                            createTitle={t('add account')}
                            error={error?.data}
                        />
                    </Modal.Body>
                </Modal>
