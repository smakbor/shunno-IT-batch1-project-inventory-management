...
const WarrantyCreateUpdate = ({ modal, setModal, toggle, editData, defaultValues }) => {
    ...
    const schemaResolver = yupResolver(
        yup.object().shape({
            name: yup.string().required(t('please enter Warranty name')).min(3, t('minimum containing 3 letter')),
            note: yup.string(),
        })
    );
    ...
    const onSubmit = async (formData) => {
        editData ? warrantyUpdate({ id: editData._id, postBody: formData }) : warrantyCreate(formData);
    };
...
export default WarrantyCreateUpdate;
